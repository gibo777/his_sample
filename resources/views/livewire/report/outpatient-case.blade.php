<div>
@include('modal.report.printoutpatient')
    ...
    <div class="overflow-auto outpatient-div pb-0 border-radius-25 px-3">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <i class="fa-solid fa-print report-buttons" id="outpatient_report_printbtn"></i>
                <i class="fa-solid fa-file-pdf report-buttons " id="outpatient_report_pdfbtn"></i>
                <i class="fa-solid fa-file-excel report-buttons " id="outpatient_report_excelbtn"></i>
            </div>
    ...
    {{-- <button id="openmodal"></button> --}}
        {{-- <div class="row">
            ...
            class="border-radius-25 searchbar" wire:model="search" autocomplete="off" />
        </div> --}}
    </div>
        ...
        <table class=" table table-striped" id="patients">
            <thead>
                ...
                <th class="table-name-mname">
                    <span class="float-left" >MEDICAL RECORD No. (MRN)
                ...
                <th class="table-name-mname">
                    <span class="float-left" > ATTENDING PHYSICIAN
            ...
            <tbody>
@if (sizeof($outpatientlist) > 0)
@foreach ($outpatientlist as $pat )
...
@endif
        ...
        <div class="row pagination-content float-right mt-3 mr-1">
            {{ $outpatientlist->links('livewire.custom-pagination') }}
        </div>
    </div>
    </div>
