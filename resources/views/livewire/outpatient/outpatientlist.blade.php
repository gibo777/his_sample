...
<div>
    <div class="overflow-auto outpatient-div pb-0 border-radius-25 mb-4 px-3" id="custom-scroll">
          ...
          <table class="table" id="patients" >
              ...
              <tbody>
                @if (sizeof($patients) > 0)
                    ...
                    <tr class="mb-3 ipPatientInfo" ondblclick="outpatientRecord('{{ $patient->U_PATIENTID }}','img/profile.png')">
                        <td >{{ $patient->DOCNO }}</td>
