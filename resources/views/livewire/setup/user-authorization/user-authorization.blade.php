<div class="user-autorization-div border-radius-25">
    <div class="container">
        <div class="row setup-user-autorization-row" >
            <div class="col p-3">
                <div class="row">
                    <div class="col">
                        <h5>Select User</h5>
                ...
                <div class="row">
                    <div class="col setup-user-autorization-col overflow-auto" id="custom-scroll">
