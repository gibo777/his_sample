<div>
    @include('modal.inpatient.medical-body-mass')
    @include('modal.inpatient.medical-procedure-history')
    @include('modal.inpatient.medical-condition-modal')
    @include('modal.inpatient.family-health-modal')
    @include('modal.inpatient.allergies-modal')
    <form action="" method="">
                            ...
                            <div class="row mx-5">
                                ...
                                <div class="col d-inline ">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#inpatientBodyMass">
                                                Add
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col d-inline">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#inpatientMedicalConditionModal">
                                                Add
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="row mx-5">
                                ...
                                <div class="col d-inline ">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#inpatientFamilyHealthModal">
                                                Add
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col d-inline">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#inpatientProcedureHistoryModal">
                                                Add
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="row mx-5">
                                ...
                                <div class="col-6 d-inline ">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#inpatientAllergiesModal">
                                                Add
                                            </button>
                                        </div>
                                    </div>
