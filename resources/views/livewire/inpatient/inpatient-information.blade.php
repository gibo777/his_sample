...
<div class="inpatient-profile mb-3 border-radius-25">
    ...
    <div class="row patient-row ">
        <div class="patient-col col">
            <i class="fa-solid fa-bars" id="inpatientMenuIcon"></i>
            <div id="inpatientTabList">
            ...
            <div class="tab-content border-radius-25" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-patient-info" role="tabpanel"
                    ...
                    <form action="" method="" id="patientInformationUpdateForm">
                        <div class="pi-container">
                            <div class="row pt-2">
                                <div class="hidden">
                                    <input type="hidden" id="inpatientViewPInfo" value="{{$authPage!='R'?'F':'R'}}">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-size-1">
                                    ...
                                    <input id="patientBirthdate" name="U_BIRTHDATE"
                            ...
                            <div class=" text-end" style="width:100px; float:right; margin-top:-45px; right:45px; position: absolute;">
                                <a role="button" id="patientInformationUpdateButton" class="btn btn-primary border-radius-25 ">Save</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="inpatientBgInfo tab-pane fade" id="nav-background-info" role="tabpanel" aria-labelledby="nav-background-info-tab" tabindex="0">
                    @livewire('inpatient.inpatient-background-information', ['id' => $patients->CODE])
                </div>
                ...
                <div class="tab-pane fade" id="nav-hmo-info" role="tabpanel" aria-labelledby="nav-hmo-info-tab" tabindex="0">
                    @livewire('inpatient.hmo-information', ['id' => $patients->CODE])
                </div>
                ...
                <div class="tab-pane fade" id="nav-medical-info" role="tabpanel" aria-labelledby="nav-medical-info-tab" tabindex="0">
                    @livewire('inpatient.inpatient-medical-information', ['id' => $patients->CODE])
                </div>
                ...
                <div class="tab-pane fade" id="nav-case-info" role="tabpanel" aria-labelledby="nav-case-info-tab" tabindex="0">
                    @livewire('inpatient.inpatient-case-information', ['id' => $patients->CODE])
                </div>
                ...
                <div class="tab-pane fade" id="nav-new-case" role="tabpanel" aria-labelledby="nav-new-case-tab" tabindex="0">
                    @livewire('inpatient.inpatient-new-case', ['id' => $patients->CODE, 'hasActive'=>$hasActive])
                </div>
