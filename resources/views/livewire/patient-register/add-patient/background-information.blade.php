                ...
                @if (!is_null($bgInfos))
                    ...
                    <div class="row">
                        <div class="bi-col-1">
                            ...
                            <input type="text" name="U_BG_LASTNAME" id="U_BG_LASTNAME-0" class="border-radius-25" value="{{$bgInfo->U_BG_LASTNAME?$bgInfo->U_BG_LASTNAME:''}}">
                        </div>
                        <div class="bi-col-1">
                            <label for="" class="d-block">First Name <span class="text-danger">*</span></label>
                            <input type="text" name="U_BG_FIRSTNAME" id="U_BG_FIRSTNAME-0" class="border-radius-25"value="{{$bgInfo->U_BG_FIRSTNAME?$bgInfo->U_BG_FIRSTNAME:''}}">
                        </div>
                        <div class="bi-col-1">
                            <label for="" class="d-block">Middle Name <span class="text-danger">*</span></label>
                            <input type="text" name="U_BG_MIDDLENAME" id="U_BG_MIDDLENAME-0" class="border-radius-25"value="{{$bgInfo->U_BG_MIDDLENAME?$bgInfo->U_BG_MIDDLENAME:''}}">
                        </div>
                        <div class="bi-col-2">
                            <label for="" class="d-block">Ext.</label>
                            <input type="text" name="U_BG_EXTNAME" id="U_BG_EXTNAME-0" class="border-radius-25" value="{{$bgInfo->U_BG_EXTNAME?$bgInfo->U_BG_EXTNAME:''}}">
                        </div>
                        <div class="bi-col-1">
                        ...
                        <div class="bi-col-1">
                            ...
                            <input type="text" name="U_BG_CONTACTNO" id="U_BG_CONTACTNO-0" class="border-radius-25" value="{{$bgInfo->U_BG_CONTACTNO?$bgInfo->U_BG_CONTACTNO:''}}">
                        </div>
                        <div class="bi-col-1">
                            <label for="" class="d-block">Second Contact No.</label>
                            <input type="text" name="U_BG_CONTACTNO2ND" id="U_BG_CONTACTNO2ND-0" class="border-radius-25" value="{{$bgInfo->U_BG_CONTACTNO2ND?$bgInfo->U_BG_CONTACTNO2ND:''}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="bi-col-1">
                        ...
                        <div class="bi-col-3">
                            ...
                            <input type="text" name="U_BG_STREET" id="U_BG_STREET-0" class="border-radius-25"  value="{{$bgInfo->U_BG_STREET?$bgInfo->U_BG_STREET:''}}">
                        </div>
                        <div class="bi-col-1">
                            <label for="" class="d-block">Zip Code <span class="text-danger">*</span></label>
                            <input type="text" name="U_BG_ZIP" id="zip-background-reg-0" class="border-radius-25"  value="{{$bgInfo->U_BG_ZIP?$bgInfo->U_BG_ZIP:''}}" readonly>
                        </div>
                    </div>
                </div>
                @endforeach
