<div>
    @include('modal.patient-register.medical-body-mass')
    @include('modal.patient-register.medical-procedure-history')
    @include('modal.patient-register.medical-condition-modal')
    @include('modal.patient-register.family-health-modal')
    @include('modal.patient-register.allergies-modal')
    <form action="" method="">
                                ...
                                <div class="col d-inline ">
                                    <div class="row px-1">
                                        ...
                                        <div class="col-3 px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#patientBodyMass">
                                                Add
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col d-inline">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#patientRegisterMedicalConditionModal">
                                                Add
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="row mx-5">
                                ...
                                <div class="col d-inline ">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#patientRegisterFamilyHealthModal">
                                                Add
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col d-inline">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#patientRegisterProcedureHistoryModal">
                                                Add
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="row mx-5">
                                ...
                                <div class="col-6 d-inline ">
                                    <div class="row px-1">
                                        ...
                                        <div class="col px-1 text-end">
                                            <button type="button" class="border-radius-25 btn btn-primary" data-bs-toggle="modal" data-bs-target="#patientRegisterAllergiesModal">
                                                Add
                                            </button>
                                        </div>
                                    </div>
