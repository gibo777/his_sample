...
<div class="reg-profile mb-3 border-radius-25">
    ...
    <div class="row patient-row ">
        ...
        <div class="patient-info pt-3">
            ...
            <h3 id="patientFullName">{{ $patients->U_LASTNAME }}, {{ $patients->U_FIRSTNAME }} {{ $patients->U_MIDDLENAME }}</h3>
    ...
    <div class="row patient-row ">
        <div class="patient-col col">
            <ul class="nav nav-tabs justify-content-end" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link new-case" id="nav-new-case-tab" data-bs-toggle="tab" data-bs-target="#nav-register-new-case"
                        type="button" role="tab" aria-controls="nav-register-new-case" aria-selected="false">
            ...
            <div class="tab-content border-radius-25" id="nav-tabContent">
                        ...
                        <div class="pi-container">
                            <div class="row pt-2">
                                <div class="col-6 d-inline-block">
                                    ...
                                    <input type="text" class="border-radius-25 mx-3 input-custom-1" name="CODE" id="patient-mrn"
                            ...
                            <div class="row">
                                <div class="col-size-1">
                                    ...
                                    <input type="date" id="patientBirthdate" name="U_BIRTHDATE"
                                        class="border-radius-25 datetimepicker d-block" placeholder="mm-dd-yyyy"
                                        value="{{ $patients->U_BIRTHDATE }}">
                                </div>
                                <div class="col-size-1">
                            ...
                            {{-- <div class=" text-end" style="width:100px; float:right; margin-top:-45px; right:45px; position: absolute;">
                                <a role="button" id="patientInformationUpdateForm" class="btn btn-primary border-radius-25 ">Save</a>
                            </div> --}}
                            
                        </div>
                        <div class="hidden">
                            <input type="hidden" id="restrictionViewRecord" value="{{$authPage!='R'?'F':'R'}}">
                        </div>
                        <div class=" text-end" style="width:100px; float:right; margin-top:-45px; right:45px; position: absolute;">
                ...
                <div class="patientBgInfo tab-pane fade" id="nav-background-info" role="tabpanel" aria-labelledby="nav-background-info-tab" tabindex="0">
                    
                            @livewire('patient-register.background-information', ['id' => $patients->CODE])
                    {{-- </div> --}}
                </div>
                ...
                <div class="tab-pane fade" id="nav-hmo-info" role="tabpanel" aria-labelledby="nav-hmo-info-tab" tabindex="0">
                    @livewire('patient-register.hmo-information', ['id' => $patients->CODE])
                </div>
                ...
                <div class="tab-pane fade" id="nav-medical-info" role="tabpanel" aria-labelledby="nav-medical-info-tab" tabindex="0">
                    @livewire('patient-register.medical-information', ['id' => $patients->CODE])
                </div>
                ...
                <div class="tab-pane fade" id="nav-case-info" role="tabpanel" aria-labelledby="nav-case-info-tab" tabindex="0">
                    @livewire('patient-register.case-information', ['id' => $patients->CODE])
                </div>
                ...
                <div class="tab-pane fade" id="nav-register-new-case" role="tabpanel" aria-labelledby="nav-register-new-case-tab" tabindex="0">
                    @livewire('patient-register.new-case',['id' => $patients->CODE,'hasActive' => $hasActive ?? ''])
                </div>
