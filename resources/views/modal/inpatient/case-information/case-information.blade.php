        ...
        <div class="modal-dialog modal-xl modal-dialog-centered overflow-auto">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="outpatientCaseInformationModalLabel"><span class="">Inpatient</span> Case Information</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body inpatient-case-information-modal-body overflow-auto">
                    <div class="container" id="caseInfoFields">
                        ...
                        <div class="row pt-2">
                            ...
                            <div class="col-4 col">
                                <div class="row pt-2 px-2 text-center" id="caseInfoVitalSign">
                                    <h6>Vital Signs</h6>
                                    <div class="vital-signs-div border-radius-25 px-2 overflow-auto" id="custom-scroll">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>Date/Time</th>
                                ...
                                <div class="row pt-2 px-2 text-center" id="caseInfoDispensary">
                                    <h6>Dispensary</h6>
                                    <div class="dispensary-div border-radius-25 px-2 overflow-auto" id="custom-scroll">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>Date/Time</th>
                                ...
                                <div class="row p-2 text-center" id="CasInfoMayGoHomeId" hidden>
                                    ...
                                    <div class="inpatient-may-go-home-div border-radius-25 p-2 overflow-auto" id="custom-scroll">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>Department</th>
