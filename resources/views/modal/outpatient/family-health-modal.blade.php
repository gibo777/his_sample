<!-- Modal -->
<div class="modal fade" id="outpatientFamilyHealthModal" data-bs-backdrop="false" data-bs-keyboard="true" tabindex="-1" aria-labelledby="outpatientFamilyHealthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="outpatientFamilyHealthModalLabel">Family Health History</h1>
